...
idyom_data %>%
  select(melody.name, note.id, scale_degree) %>%
  filter(note.id == 1) %>%
  group_by(scale_degree) %>%
  summarise(counts = n()) -> huron_start_table

write_csv(huron_start_table, path = "data/aggregate_data/huron_start_table.csv")
...
helpful_list[helpful_list$idyom_notation=="0 9 8",]$average_ic <- as.numeric(find_3_grams(0,9,8, idyom_data) 
                                                                             %>% get_string_idyom_ic())
#--------------------------------------------------
helpful_list[helpful_list$idyom_notation=="0 10 11",]$average_ic <- as.numeric(find_3_grams(0,10,11, idyom_data) 
                                                                               %>% get_string_idyom_ic())
#--------------------------------------------------
...
helpful_list[helpful_list$idyom_notation=="9 7 5 4 2",]$average_ic <- as.numeric(find_5_grams(9,7,5,4,2, idyom_data) 
                                                                                 %>% get_string_idyom_ic())
#--------------------------------------------------
helpful_list[helpful_list$idyom_notation=="7 9 11 0 7",]$average_ic <- as.numeric(find_5_grams(7,9,11,0,7, idyom_data) 
                                                                                  %>% get_string_idyom_ic())
#--------------------------------------------------
# START SEVEN 
#--------------------------------------------------
